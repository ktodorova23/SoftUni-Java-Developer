<%@ page import="app.domain.models.CarViewModel" %>
...
<div class="container-fluid">
    ...
    <hr style="width: 50%"/>
        <ul style="list-style-type: none; color: white; text-align: center" class='row mb-4 d-flex justify-content-around'>
            <% for (CarViewModel car : (List<CarViewModel>) request.getAttribute("allCars")) {%>
